# python src/scripts/predict_flops.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/final.json -o src/scripts/paper/figures/chained_flops_main.pdf -n 6887575552 -d 3945065873408 -t 7B-4T --skip_perc 0.1 --moving_avg 5
...
def main():
    ...
    for r, task_name in enumerate(args.keys):
        ...
        (
            ...
            plotted_predicted_data_by_name,
            (y, y_pred, rel_error),
        ) = predict_chained_flops(single_step_data_by_name, step1_coefficients, step2_coefficients)
