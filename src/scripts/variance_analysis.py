# python src/scripts/variance_analysis.py -k v2_main_variance -c src/scripts/paper/configs/final_variance.json -o src/scripts/paper/figures/variance.pdf --last_n_points 10 --run_prediction
...
def run_two_step_prediction(keys_key, variant=None):
    ...
    step1_args = [
        ...
        keys_key,
        "-c",
        "src/scripts/paper/configs/final_7b_only.json",
        "-o",
        "/tmp/step1_main.pdf",
        "--moving_avg",
        "5",
    ...
    predict_args = [
        ...
        keys_key,
        "-c",
        "src/scripts/paper/configs/final.json",
        "--step2-config-path",
        "src/scripts/paper/configs/final_7b_only.json",
        "-o",
