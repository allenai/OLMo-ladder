# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/final.json -o src/scripts/paper/figures/chained_main.pdf -n 6887575552 -d 3945065873408 -t 7B-4T --skip_perc 0.1 --moving_avg 5
...
# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/final.json -o src/scripts/paper/figures/chained_c4_main.pdf -n 6887575552 -d 3945065873408 -t 7B-4T --skip_perc 0.1 --moving_avg 5 --x_metric c4
# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/final.json -o src/scripts/paper/figures/chained_c4_main.pdf -n 13202396160 -d 5000088518656 -t 13B-5T --skip_perc 0.1 --moving_avg 5 --x_metric c4
# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/step2_mc_7B.json -o src/scripts/paper/figures/chained_mc_7B_main.pdf -y mc_acc -n 6887575552 -d 3945065873408 -t 7B-4T --moving_avg 5
# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/step2_mc_13B.json -o src/scripts/paper/figures/chained_mc_13B_main.pdf -y mc_acc -n 13202396160 -d 5000088518656 -t 13B-5T --moving_avg 5
# python src/scripts/predict.py -k v2_main -c src/scripts/paper/configs/final.json --step2-config-path src/scripts/paper/configs/final.json -o src/scripts/paper/figures/chained_taskce_main.pdf -n 6887575552 -d 3945065873408 -t 7B-4T --skip_perc 0.5 --x_metric rc_soft_log  --use_log_sigmoid
...
from ladder.fitting.step1 import fit_step1
